...
/* bien/new.html.twig */
class __TwigTemplate_e5a99473a9be90ec4493145109bd1e88ace23ba22d8ea7282d1a6a6c857ce996 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Create new Bien</h1>

    ";
        // line 8
        echo twig_include($this->env, $context, "bien/_form.html.twig");
        echo "
...
{% block title %}New Bien{% endblock %}

{% block body %}
    <h1>Create new Bien</h1>

    {{ include('bien/_form.html.twig') }}

    <a href=\"{{ path('bien_index') }}\">back to list</a>
{% endblock %}
", "bien/new.html.twig", "D:\\exercices\\Wf3\\SYMFONY\\immo\\templates\\bien\\new.html.twig");
    }
}
