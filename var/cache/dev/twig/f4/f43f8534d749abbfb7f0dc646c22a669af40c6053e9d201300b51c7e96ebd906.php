...
class __TwigTemplate_6ecac91783468890a794ce5589a1625c391b0a4809ba22949ba89ebc45dc06ea extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 7
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 7, $this->source); })()), "request", [], "any", false, false, false, 7), "get", [0 => "_route"], "method", false, false, false, 7) == "bien_edit")) {
            // line 8
...
";
    ...
    {
        return array (  72 => 13,  69 => 12,  63 => 9,  60 => 8,  58 => 7,  53 => 5,  47 => 2,  43 => 1,);
    }
    ...
    \t</div>
    {% if app.request.get('_route') == 'bien_edit' %}
\t    <div class=\"col-2\">
...
{{ form_end(form) }}
", "user/_form.html.twig", "D:\\exercices\\Wf3\\SYMFONY\\immo\\templates\\user\\_form.html.twig");
    }
}
