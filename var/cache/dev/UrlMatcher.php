...
return [
    ...
    [ // $staticRoutes
        ...
        '/bien' => [[['_route' => 'bien_index', '_controller' => 'App\\Controller\\BienController::index'], null, ['GET' => 0], null, true, false, null]],
        '/bien/new' => [[['_route' => 'bien_new', '_controller' => 'App\\Controller\\BienController::new'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        186 => [[['_route' => 'bien_show', '_controller' => 'App\\Controller\\BienController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        199 => [[['_route' => 'bien_edit', '_controller' => 'App\\Controller\\BienController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        207 => [[['_route' => 'bien_delete', '_controller' => 'App\\Controller\\BienController::delete'], ['id'], ['DELETE' => 0], null, false, true, null]],
        ...
        292 => [[['_route' => 'fos_user_registration_confirm', '_controller' => 'fos_user.registration.controller:confirmAction'], ['token'], ['GET' => 0], null, false, true, null]],
        322 => [
